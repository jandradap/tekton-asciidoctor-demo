= Tekton: Task asciidoctor demo
Jorge Andrada Prieto
v1.0, 2022-01-09
:description: Example template for \
generate documentation as code \
for Tekton.
:organization: Continuous Delivery Foundation
:header_content: Tekton task asciidoctor
:doctype: book
ifeval::["{draft}" == "yes"]
...
:title-page-background-image: image:./images/banner.png[pdfwidth=8.25in,align=top]
...
:warning-caption: Peligro
endif::[]
// URIs:
:uri-devoxx: https://andradaprieto.es
